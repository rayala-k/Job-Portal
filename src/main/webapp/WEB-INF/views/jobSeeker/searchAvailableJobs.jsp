	...
	<div class="navbar navbar-inverse" role="navigation">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav searhBarNav">
				...
				<li class="active"><a href="availableJobs.htm">Available
						Jobs</a></li>
			</ul>
		</div>
	</div>
			...
			<form role="form" action="searchByCandidate.htm">
				...
				<div class="row-fluid">
					<div class="col-sm-3 form-group has-feedback">
						<input class="form-control  input-lg" id="jobTitle"
							name="jobTitle" type="text" placeholder="job title"> <span
							class="glyphicon glyphicon-time form-control-feedback"
							style="font-size: 20px; margin-right: 10px;"></span>
					</div>
					<div class="col-sm-3 form-group has-feedback">
						<input class="form-control  input-lg" id="skill" name="skill"
							type="text" placeholder="skill"> <span
							class="glyphicon glyphicon-briefcase form-control-feedback"
							style="font-size: 20px; margin-right: 10px;"></span>
					</div>
					<div class="col-sm-3 form-group has-feedback">
						<input class="form-control  input-lg" id="companyName"
							name="companyName" type="text" placeholder="company"> <span
							class="glyphicon glyphicon-briefcase form-control-feedback"
							style="font-size: 20px; margin-right: 10px;"></span>
					</div>
					<div class="col-sm-3 form-group has-feedback">
						<input class="form-control  input-lg" id="location"
							name="location" type="text" placeholder="location"> <span
		...
		<div class="col-sm-12">
			<c:forEach items="${jobs}" var="job">
				<div class="row">
					...
					<div class="col-xs-12">
						<h2>${job.jobTitle}</h2>
						<h4>
							<i class="glyphicon glyphicon-briefcase"></i>&nbsp;${job.companyName}
						</h4>
						...
						<ul class="list-inline">
							<li><a href="#"><i class="glyphicon glyphicon-calendar"></i>
									${job.postedDate}</a></li>
							<li><a href="#"><i
									class="glyphicon glyphicon-map-marker"></i> ${job.location}</a></li>
						</ul>
					</div>
			...
			<ul class="pagination">
				...
				<c:if test="${currentPage != 1}">
					<li><a href="searchByCandidate.htm?page=${currentPage - 1}">Previous</a></li>
				</c:if>
				<c:forEach begin="1" end="${noOfPages}" var="i">
					<c:choose>
						...
						<c:otherwise>
							<li><a href="searchByCandidate.htm?page=${i}">${i}</a></li>
						</c:otherwise>
					</c:choose>
				</c:forEach>
				<%--For displaying Next link --%>
				<c:if test="${currentPage lt noOfPages}">
					<li><a href="searchByCandidate.htm?page=${currentPage + 1}">Next</a></li>
				</c:if>
			</ul>
